...
const emit = defineEmits(['drone-clicked', 'map-clicked', 'coordinates-selected', 'map-loaded', 'event-clicked',    'patrol-area-drawn',
'patrol-area-clicked'])
...
watch([showDrones, showEvents, showFlightPaths], () => {
if (deck) {
  renderDeckLayers()
}
})
